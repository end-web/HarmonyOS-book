...
当前版本：`0.1.7`，API 26，`com.huan.listenbook`。版本以 [AppScope/app.json5](AppScope/app.json5) 为准。

## 下载与更新

[最新版本与更新说明](https://github.com/end-web/HarmonyOS-book/releases/latest) · [下载 v0.1.7 安装包](https://github.com/end-web/HarmonyOS-book/releases/download/v0.1.7/ListenBook-v0.1.7.hap)
...
```bash
hdc install ListenBook-v0.1.7.hap
```

`v0.1.7` 更新：完善书源分组、筛选、排序、导出与锁定；新增搜索和发现/阅读批量校验；增强规则脚本兼容、网页交互与等待式登录；底部书架改用书源管理同款图标。
