...
- **SDK**: HarmonyOS 6.0+; `targetSdkVersion = 26.0.0`, `compatibleSdkVersion = 6.0.0(20)` for both App products and the QuickJS HAR; `bundleName: com.huan.listenbook`. Use `PlatformCompat` for newer APIs and lazy imports for newer system modules.
