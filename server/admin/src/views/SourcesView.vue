...
import { Activity, AlertTriangle, FileJson, Plus, RefreshCw, Search, Trash2, X } from 'lucide-vue-next';
  ...
  <section class="view">
    <header class="view-header">
      ...
      <div class="header-actions">
        <button class="icon-command" type="button" title="刷新列表" @click="load"><RefreshCw :size="19" /></button>
